...
export class ResourceDirectory extends pulumi.CustomResource {
     ...
     * - Disabled
     */
    public readonly memberAccountDisplayNameSyncStatus!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ResourceDirectoryArgs | ResourceDirectoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["memberAccountDisplayNameSyncStatus"] = state ? state.memberAccountDisplayNameSyncStatus : undefined;
            ...
            resourceInputs["memberAccountDisplayNameSyncStatus"] = args ? args.memberAccountDisplayNameSyncStatus : undefined;
