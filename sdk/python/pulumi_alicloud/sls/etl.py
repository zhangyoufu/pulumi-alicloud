...
class EtlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_name: Data processing task display name.
        :param pulumi.Input[str] job_name: Unique identification of data processing task.
        :param pulumi.Input[str] project: Project Name.
        :param pulumi.Input[str] description: Data Processing Task Description.
        """
...
class _EtlState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EtlConfigurationArgs'] configuration: The ETL configuration. See `configuration` below.
        :param pulumi.Input[int] create_time: The time when the data transformation job was created.
        :param pulumi.Input[str] description: Data Processing Task Description.
        :param pulumi.Input[str] display_name: Data processing task display name.
        :param pulumi.Input[str] job_name: Unique identification of data processing task.
        :param pulumi.Input[str] project: Project Name.
        :param pulumi.Input[str] status: The status of the data transformation job.
        """
...
class Etl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            job_name: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'Etl':
        """
