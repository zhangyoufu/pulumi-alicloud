...
class ScheduledPreloadExecutionArgs:
    def __init__(__self__, *,
                 ...
                 scheduled_preload_job_id: pulumi.Input[str],
                 slice_len: pulumi.Input[int],
                 end_time: Optional[pulumi.Input[str]] = None,
                 start_time: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a ScheduledPreloadExecution resource.
        :param pulumi.Input[int] interval: The time interval between each batch execution. Unit: seconds.
        :param pulumi.Input[str] scheduled_preload_job_id: The ID of the prefetch task.
        :param pulumi.Input[int] slice_len: The number of URLs prefetched in each batch.
        :param pulumi.Input[str] end_time: The end time of the prefetch plan.
        :param pulumi.Input[str] start_time: The start time of the prefetch plan.
        """
    ...
    def scheduled_preload_job_id(self) -> pulumi.Input[str]:
        """
    ...
    def scheduled_preload_job_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "scheduled_preload_job_id", value)

    @property
    @pulumi.getter(name="sliceLen")
    def slice_len(self) -> pulumi.Input[int]:
        """
    ...
    @slice_len.setter
    def slice_len(self, value: pulumi.Input[int]):
...
class _ScheduledPreloadExecutionState:
    def __init__(__self__, *,
                 ...
                 scheduled_preload_execution_id: Optional[pulumi.Input[str]] = None,
                 scheduled_preload_job_id: Optional[pulumi.Input[str]] = None,
                 slice_len: Optional[pulumi.Input[int]] = None,
                 start_time: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] end_time: The end time of the prefetch plan.
        :param pulumi.Input[int] interval: The time interval between each batch execution. Unit: seconds.
        :param pulumi.Input[str] scheduled_preload_execution_id: The ID of the prefetch plan.
        :param pulumi.Input[str] scheduled_preload_job_id: The ID of the prefetch task.
        :param pulumi.Input[int] slice_len: The number of URLs prefetched in each batch.
        :param pulumi.Input[str] start_time: The start time of the prefetch plan.
        :param pulumi.Input[str] status: The status of the prefetch plan, including the following statuses.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
    ...
    def scheduled_preload_execution_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def scheduled_preload_execution_id(self, value: Optional[pulumi.Input[str]]):
    ...
    @property
    @pulumi.getter(name="sliceLen")
    def slice_len(self) -> Optional[pulumi.Input[int]]:
        """
        The number of URLs prefetched in each batch.
        """
        return pulumi.get(self, "slice_len")
    ...
    @slice_len.setter
    def slice_len(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "slice_len", value)
...
class ScheduledPreloadExecution(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            slice_len: Optional[pulumi.Input[int]] = None,
            start_time: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'ScheduledPreloadExecution':
        """
    ...
    @property
    @pulumi.getter(name="scheduledPreloadExecutionId")
    def scheduled_preload_execution_id(self) -> pulumi.Output[str]:
        """
        The ID of the prefetch plan.
        """
        return pulumi.get(self, "scheduled_preload_execution_id")
    ...
    @property
    @pulumi.getter(name="sliceLen")
    def slice_len(self) -> pulumi.Output[int]:
        """
        The number of URLs prefetched in each batch.
        """
        return pulumi.get(self, "slice_len")
